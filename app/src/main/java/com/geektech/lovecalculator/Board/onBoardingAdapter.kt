...
import com.example.lovecalculator.databinding.ItemOnboardingBinding
    ...
    class onBoardingAdapter(val names:ArrayList<onBoard>, private val onClick:() -> Unit):
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BoardingViewHolder {
            return BoardingViewHolder(ItemOnboardingBinding.inflate(LayoutInflater.from(parent.context),parent,false))
        }
        ...
        inner class BoardingViewHolder(private val binding: ItemOnboardingBinding) :RecyclerView.ViewHolder(binding.root){
            fun bind(){
                with(binding) {
